  ...
  const handleNavigation = (type) => {
    ...
    switch(type) {
      ...
      case 'kakao':
        ...
        break;
      case 'tmap':
        url = `https://tmap.life/route?goalname=${encodeURIComponent(placeName)}&goalx=127.0363793&goaly=37.5028461`;
        break;
      default:
        return;
    }
  ...
  return (
    <section className="location-section">
      <div className="container">
        ...
        <div 
          ref={locationRef}
          className={`location-info-improved animate-on-scroll ${locationVisible ? 'visible' : ''}`}
        >
          <h3>세인트 메리엘</h3>
        ...
        <div 
          ...
          className={`map-container animate-scale ${mapVisible ? 'visible' : ''}`}
        ></div>
        ...
        <div className="transport-info-clean">
          <div className="transport-item-clean">
            ...
            <p className="transport-desc">신분당선 강남역 4번 출구 (도보 6분)</p>
          </div>
          ...
          <div className="transport-item-clean">
            ...
            <p className="transport-desc">강남역 1번출구, 역삼세무서 정류장 하차</p>
            <p className="transport-numbers">간선: 140, 146, 341, 360, 400, 402, 420, 440, 441, 452, 470, 541, 740, 741</p>
            <p className="transport-numbers">지선: 9404, 9408, M4403, M4434, M5438, M6427, M6439, M7412</p>
          </div>
          ...
          <div className="transport-item-clean">
            ...
            <p className="transport-desc">서울 강남구 논현로79길 72 (역삼동 828-10)</p>
            <p className="transport-desc">우편번호: 06239</p>
            <p className="transport-desc">건물 내 주차 가능 (발렛 서비스 제공)</p>
          </div>
        </div>
      </div>
    </section>
